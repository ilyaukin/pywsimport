...
DOC = """
Wrapper of %s web service.
Generated by pywsimport (http://github.com/ilyaukin/pywsimport).
"""
...
class ModuleModel(object):
    ...
    def save(self):
        if not isinstance(self.module.body[0], ast.Expr) and self.pydoc():
            self.module.body.insert(0, ast.Expr(value=ast.Str(s=self.pydoc())))
